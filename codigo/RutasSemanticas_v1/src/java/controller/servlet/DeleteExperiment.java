...
/**
 * Clase DeleteExperiment, servlet que permite eliminar una prueba del sistema.
...
public class DeleteExperiment extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(experimentId);
        
        ExperimentDaoImpl eDao = new ExperimentDaoImpl();
        
        // Borrado de la prueba,
        if(id == -1){
            eDao.deleteAllExperiments();
        }else{
            eDao.deleteExperiment(id);
        }
    ...
    public String getServletInfo() {
        return "DeleteExperiment servlet";
    }// </editor-fold>
